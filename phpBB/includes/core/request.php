...
class phpbb_request
{
	...
	*/
	...
	/**
	* @var phpbb_request Global instance of this class
	*/
	...
	*
	* @return	phpbb_request	An instance of this class
	*/
	public static function get_instance()
	{
		if (!self::$instance)
		{
			self::$instance = new phpbb_request();
		}
	...
	*/
	protected function __construct()
	{
		...
		$this->original_request = $this->input[phpbb_request::REQUEST];
		$this->input[phpbb_request::REQUEST] = $this->input[phpbb_request::POST] + $this->input[phpbb_request::GET];
	...
	*/
	public function overwrite($var_name, $value, $super_global = phpbb_request::REQUEST)
	{
	...
	*/
	public function variable($var_name, $default, $multibyte = false, $super_global = phpbb_request::REQUEST)
	{
		$path = false;
	...
	*/
	...
	{
		return $this->is_set($name, phpbb_request::POST);
	}
	...
	*/
	public function is_set($var, $super_global = phpbb_request::REQUEST)
	{
	...
	*/
	public function variable_names($super_global = phpbb_request::REQUEST)
	{
