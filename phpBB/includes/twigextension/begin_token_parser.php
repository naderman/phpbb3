 ...
 */
class phpbb_twigextension_begin_token_parser extends Twig_TokenParser
{
	/**
	...
	*/
	public function parse(Twig_Token $token)
	{
		...
		return new phpbb_twigextension_begin_node($beginName, $body, $else, $lineno, $this->getTag());
	}

    public function decideBeginFork($token)
    {
        return $token->test(array('BEGINELSE', 'END'));
    }

    public function decideBeginEnd($token)
    {
